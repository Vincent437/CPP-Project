...
Mat::Mat(double _time) : time_stamp(_time)
{
...
Dat::Dat(double _steer, double _speed, double _time) : steer(_steer), speed(_speed), time_stamp(_time)
{
...
Dota::Dota(int _sign) : sign(_sign)
{
